...
El codigo que os interesa esta en la clase Recomendador. Esta clase tiene dos metodos:
...
El test requiere que hagais dos cambios funcionales:
...
Como veis son dos cambios diferentes: uno en el algoritmo de recomendacion, otro en la forma de
...
Despues, adaptad el codigo del test para la nueva estructura.

Suerte y no dudeis en preguntar cualquier duda.